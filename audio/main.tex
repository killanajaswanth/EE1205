...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11033-KILLANA JASWANTH$^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
$https://github.com/killanajaswanth/EE1205/blob/main/Audio_%20Filter/codes/jaswanth.wav
\end{lstlisting}
\item 
\label{Python code}
A Python Code is written to achieve Audio Filtering 
\lstinputlisting{audio/codes/audio_filter.py}\label{prob:audio_filter_problem}
...
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/2.2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
%
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/5.4.py   
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/6.1.py 
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/killanajaswanth/EE1205/tree/main/Audio_%20Filter/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
